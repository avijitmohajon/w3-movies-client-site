...
const Footer = () => {
  return (
    <footer className="footer footer-center pt-3 pb-2 items-center justify-center text-white">
      <aside>
        <p className="text-lg font-semibold">
          <span className="text-xl md:text-4xl  font-bold">
            {" "}
            W3 <small>Movies</small>
          </span>
          <br />
          "Bringing stories to life, one frame at a time"
        </p>
      </aside>
      <div className="border-x-4 border-[#DAD2FF] rounded-2xl px-8">
        <nav className="flex flex-col gap-2 text-[#DE3163] text-lg mb-2">
          <h2 className="text-slate-300 ">Explore More:</h2>
          <div className="flex space-x-5">
            <Link className="link link-hover">Trending Movies</Link>
      ...
      <p className=" border-t-2 pt-4 w-full">
