...
import { FaFilm, FaHome, FaSearch, FaTicketAlt } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <motion.p className="text-xl text-gray-300 mb-8" variants={itemVariants}>
          ...
          Maybe it's in production or on an extended intermission.
        </motion.p>

        <motion.div className="flex flex-wrap justify-center gap-4 mb-10" variants={itemVariants}>
          <button 
            onClick={() => navigate('/')}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">
                Check your spelling or try different keywords. Our search is case-sensitive.
              </p>
            </div>
          </div>
        </motion.div>
